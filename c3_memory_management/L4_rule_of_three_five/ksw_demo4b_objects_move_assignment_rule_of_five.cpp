...
1) Whenever temporary rvalues are involved in the context of assigment, the move assignment operator 
...
s2 is not a rvalue. it is an lvalue. By default the copy assignment operator will be called
...
int main(){
    ...
    */
    ...
    cout<<"----------- Eveything until above this line is fine, since there is no copying/MPVING involved--------"<<endl;

    cout<<"\n\n ---------ii) MOVE ONE OBJECT TO ANOTHER.  "<<endl;
    cout<<"So there should be no double deletion-----"<<endl;
    s1 = move(s2);
    cout<<"\n\n -------- Student S1:after moving S2 to S1 ---------"<<endl;
    s1.print_details();

    cout<<"\n\n -------- Student S2: after moving contents to S1. ptr2 and assistant_tptr2 SHOULD BE NULL -----------"<<endl;
    s2.print_details();
    


    cout<<" \n\n======== Going to create s3======================="<<endl;
    // Note this makes no sense that I invoke pass_and_return_student from s2 and pass s2, and return s2
    // But this is just a demo for passing and returning an object with a move constructor
    // Move Assignment Operator.  This is assignment. So the move assignement oeprator should be called 
    Student s3 ;
    s3 = pass_and_return_student(s2);
    cout <<"\n &s3 = "<<&s3<<endl;
